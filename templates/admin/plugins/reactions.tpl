	...
	<div class="row m-0">
		<div id="spy-container" class="col-12 col-md-8 px-0 mb-4" tabindex="0">
			<form role="form" class="reactions-settings">
				...
				<div class="mb-3">
					<h5 class="fw-bold tracking-tight settings-header">{{tx("reactions:settings.allowed-post-reactions")}}</h5>
					<p class="form-text">
						{{tx("reactions:settings.allowed-post-reactions-help")}}
					</p>
					<div class="form-group" data-type="sorted-list" data-sorted-list="allowed-post-reactions" data-item-template="admin/plugins/reactions/partials/sorted-list/allowed-emoji-item" data-form-template="admin/plugins/reactions/partials/sorted-list/allowed-emoji-form">
						...
						<button type="button" data-type="add" class="btn btn-info mt-2">{{tx("reactions:settings.allowed-post-reactions.add")}}</button>
					</div>
				</div>
